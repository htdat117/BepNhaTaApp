...
public class ShippingPolicyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDieuKhoan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShippingPolicyActivity.this, TermsOfUseActivity.class);
        ...
        btnBaoMat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShippingPolicyActivity.this, PrivacyPolicyActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnGiaoHang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShippingPolicyActivity.this, ShippingPolicyActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnDoiTra.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShippingPolicyActivity.this, ReturnPolicyActivity.class);
                startActivity(intent);
                finish();
            }
        });
