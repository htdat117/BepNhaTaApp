...
public class ReturnPolicyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDieuKhoan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReturnPolicyActivity.this, TermsOfUseActivity.class);
        ...
        btnBaoMat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReturnPolicyActivity.this, PrivacyPolicyActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnGiaoHang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReturnPolicyActivity.this, ShippingPolicyActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnDoiTra.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ReturnPolicyActivity.this, ReturnPolicyActivity.class);
                startActivity(intent);
                finish();
            }
        });
