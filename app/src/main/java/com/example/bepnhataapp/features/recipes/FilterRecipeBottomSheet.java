...
import com.example.bepnhataapp.databinding.BottomSheetFilterRecipeBinding;
...
public class FilterRecipeBottomSheet extends BottomSheetDialogFragment {

    private BottomSheetFilterRecipeBinding binding;
    ...
    public static class FilterCriteria {
        ...
        public Set<String> healths;
        public Integer maxKcal;
    ...
    public void setInitialCriteria(FilterCriteria c){ this.initialCriteria = c; }
    public FilterRecipeBottomSheet() {}

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = BottomSheetFilterRecipeBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setupTagFlex(binding.flexFlavor, flavorTags, false);
        setupTagFlex(binding.flexHealth, healthTags, false);
        ...
        if(initialCriteria!=null){
            ...
            preselectTags(binding.flexFlavor, initialCriteria.flavors);
            preselectTags(binding.flexHealth, initialCriteria.healths);
        }
        ...
        binding.btnApply.setOnClickListener(v -> {
            if(listener != null){
                ...
                c.flavors = getSelectedTags(binding.flexFlavor);
                c.healths = getSelectedTags(binding.flexHealth);
        ...
        binding.btnClear.setOnClickListener(v -> {
            ...
            resetSelections(binding.flexFlavor);
            resetSelections(binding.flexHealth);
